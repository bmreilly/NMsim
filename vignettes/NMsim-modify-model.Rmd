...
my.file.diff <- function(file1,file2,sections=NULL){
    if(is.null(sections)){
        ...
        res.file1 <- setNames(lapply(secs,function(sec)NMreadSection(file=file1,section=sections)),sections)
        res.file2 <- setNames(lapply(secs,function(sec)NMreadSection(file=file2,section=sections)),sections)
    }

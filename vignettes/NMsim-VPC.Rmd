...
This shows how to generate simulations for VPC plots. While `NMsim`
does not include functionality for summarizing quantiles or plotting,
it provides powerful ways to obtain the simulated results. We shall
see how the `tidyvpc` package easily creates VPC plots based on the
simulation results.
